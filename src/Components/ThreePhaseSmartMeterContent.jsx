import diagram from "../assets/products/threephase-diagram.png";

function ThreePhaseSmartMeterContent() {
  const features = [
  ...
  return (
    <section className="product-about">
      <div className="product-about-text">
        <h2>About Three Phase Smart Meter</h2>
        <p>
          CISNR Smart Meter is three phase whole current smart energy meter
      ...
      <div className="product-about-image">
        <img
          src={diagram}
          alt="Three Phase Smart Meter distribution diagram"
...
export default ThreePhaseSmartMeterContent;